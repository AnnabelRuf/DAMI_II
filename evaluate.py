...
# SHAP analysis
def shap_analysis(model, X_train, X_test, output_dir, name, config_name, sample_size, visualize):
...
def evaluate_model(model, name, config_name, X_train, X_test, y_test, output_dir, sample_size=None, visualize=True):
        ...
        shap_analysis(model=model, X_train=X_train, X_test=X_test, output_dir=output_dir, name=name, config_name=config_name, sample_size=sample_size, visualize=visualize)

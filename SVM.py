...
if __name__ == "__main__":
    ...
    evaluate_model(model=model, name="SVM", config_name="C-100_gamma-1_kernel-rbf", X_train=X_train, X_test=X_test, y_test=y_test, output_dir=f"SVM_output/{cell_line}", sample_size=100)
